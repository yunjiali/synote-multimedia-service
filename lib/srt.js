/*
 * Code modified based on Colingo's srt nodejs module
 * https://github.com/Colingo/srt-parser/blob/master/index.js
 */
var SECOND = 1000
    , MINUTE = 60 * SECOND
    , HOUR = 60 * MINUTE
...
function fromFile(language, fileName, callback) {
